...
public class ClusterTestMaster2{
   ...
   public static void main(String[] args) throws Exception{
      ...
      try{
         ClusterMaster2 master = new ClusterMaster2(
               "WordAnalysis", "wordanalysis", ClusterMaster2.MASTER_NODE_NETTY_PORT_DEFAULT,
               ClusterMaster2.HTTP_PORT_DEFAULT, "wordanalysis");
